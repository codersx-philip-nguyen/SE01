...
import a3_1801040111.kengine.Doc;
import a3_1801040111.kengine.DocCnt;
import a3_1801040111.kengine.Engine;
import a3_1801040111.kengine.Query;
...
public class CustomerWorkSheet {
  ...
  public Customer createCustomer(String[] data) throws NotPossibleException {
	  if(data == null || data.length != 4) {
		  throw new NotPossibleException("CustomerWorkSheet.createCustomer: Failed!");
	  }
	 try {
  ...
  public HighEarner createHighEarner(String[] data) throws NotPossibleException {
	  if(data == null || data.length != 5) {
		  throw new NotPossibleException("CustomerWorkSheet.createHighEarner: Failed!");
	  }
	 try {
		 HighEarner he = new HighEarner(Integer.parseInt(data[0]), data[1], data[2], data[3], Float.parseFloat(data[4]));
		 return he;
	 } catch(Exception e){
		  throw new NotPossibleException("CustomerWorkSheet.createHighEarner: Failed!");
	 }
  ...
  public Query search(String[] words) throws NotPossibleException {
	  if(words == null || words.length == 0) {
		  throw new NotPossibleException("CustomerWorkSheet.search: Failed!");
	  }
